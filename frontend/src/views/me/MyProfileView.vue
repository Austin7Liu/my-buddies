...
<template>
  <section v-loading="loading" class="profile-edit-page">
    <div class="section-heading"><div><p class="eyebrow accent">MY PROFILE</p><h1>个人资料</h1><p>这些资料会展示在帖子、圈子和活动中，请勿填写手机号、身份证等敏感信息。</p></div><div class="profile-actions"><RouterLink to="/me/reports"><el-button>我的举报</el-button></RouterLink><RouterLink to="/me/appeals"><el-button>我的申诉</el-button></RouterLink><RouterLink v-if="profile" :to="`/profiles/${profile.accountId}`"><el-button>查看公开主页</el-button></RouterLink></div></div>
